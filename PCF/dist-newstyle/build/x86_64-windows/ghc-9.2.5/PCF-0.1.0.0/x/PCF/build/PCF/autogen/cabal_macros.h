...
/* package PCF-0.1.0.0 */
#ifndef VERSION_PCF
#define VERSION_PCF "0.1.0.0"
#endif /* VERSION_PCF */
#ifndef MIN_VERSION_PCF
#define MIN_VERSION_PCF(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_PCF */
...
#define CURRENT_COMPONENT_ID "PCF-0.1.0.0-inplace-PCF"
